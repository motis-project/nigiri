...
TEST(rt, abi_timetable) {
  ...
  // footpaths are written in target order
  EXPECT_EQ(33, l35->footpaths[0].target_location_idx);
  EXPECT_EQ(11, l35->footpaths[0].duration);
  EXPECT_EQ(34, l35->footpaths[1].target_location_idx);
  EXPECT_EQ(8, l35->footpaths[1].duration);
  ...
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 0));
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 1));
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 2));
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 3));
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 4));
  EXPECT_EQ(true, nigiri_is_route_active(t, 0, 5));
  EXPECT_EQ(true, nigiri_is_route_active(t, 0, 6));
  EXPECT_EQ(true, nigiri_is_route_active(t, 0, 7));
  EXPECT_EQ(false, nigiri_is_route_active(t, 0, 8));
