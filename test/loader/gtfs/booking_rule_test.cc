...
TEST(gtfs, booking_rule) {
  ...
  //   EXPECT_EQ(booking_rule.prior_notice_start_day_, 0);
  //   EXPECT_EQ(booking_rule.prior_notice_start_day_, kInterpolate);
  //   EXPECT_FALSE(booking_rule.bitfield_idx_.has_value());
  // });
  //
  // ASSERT_NO_THROW({
  ...
  //   EXPECT_EQ(booking_rule.prior_notice_start_day_, hhmm_to_min("18:00:00"));
  //   EXPECT_FALSE(booking_rule.bitfield_idx_.has_value());
  // });
  //
  // ASSERT_NO_THROW({
  ...
  //   EXPECT_EQ(booking_rule.prior_notice_start_day_, hhmm_to_min("08:00:00"));
  //   EXPECT_TRUE(booking_rule.bitfield_idx_.has_value());
  // });
}
