...
static void build_permutation_vec(vecvec<location_idx_t, route_idx_t> order,
                                  uint32_t first_idx) {
...
static vector<location_idx_t> get_permutation_vector() { return permutation_; }
...
static vecvec<route_idx_t, stop::value_type> apply_permutation_to_route_loc_seq(
    vecvec<route_idx_t, stop::value_type> input) {
...
static vector_map<location_idx_t, location_idx_t>
apply_permutation_and_mapping_vec(
    vector_map<location_idx_t, location_idx_t> input) {
...
static mutable_fws_multimap<location_idx_t, location_idx_t>
apply_permutation_multimap(
    mutable_fws_multimap<location_idx_t, location_idx_t> input) {
...
static mutable_fws_multimap<location_idx_t, footpath>
apply_permutation_multimap_foot(
    mutable_fws_multimap<location_idx_t, footpath> input) {
