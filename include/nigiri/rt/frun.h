...
struct frun : public run {
  ...
  provider const& get_provider() const;
  std::string_view line() const;
  std::string_view scheduled_line() const;
  std::string_view direction() const;
  std::string_view trip_display_name() const;
  route_color get_route_color() const;
  clasz get_clasz() const;
  clasz get_scheduled_clasz() const;
  bool bikes_allowed() const;
  bool cars_allowed() const;
  bool is_cancelled() const;
