...
struct tg_line;  ///< Find the description in the tg.cc file.
struct tg_ring;  ///< Find the description in the tg.cc file.
struct tg_poly;  ///< Find the description in the tg.cc file.
struct tg_geom;  ///< Find the description in the tg.cc file.
